...
public record UpdateBulkProjectDto(
        @NotBlank @Schema String key,
        ...
        @Size(max = 100, message = "Maximum Length Description is 100 Characters")
                ...
                String description,
        @NotNull(message = "Company name can't be blank")
                @Schema(type = "string", title = "Company name")
                CompanyName company,
        @NotNull(message = "Operating country can't be blank")
        ...
        @NotBlank(message = "Service consent is required") String serviceConsentHistoryUrl) {}
